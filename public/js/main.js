...
window.onload = function(){
   ...
   redSeat.style.marginRight = window.screen.width  - 670 -60;
   for(var i = 1 ; i < redSeat.children.length; i++){
    //    redSeat.children[i].style.left =   redSeat.children[i].offsetLeft + 600 ;
    };
   // 黄方
